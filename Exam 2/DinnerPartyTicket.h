...
{
private:
	// the party this ticket is associated with
	Party * the_party; 

	// an iterator containing the party goer this ticket is associated with
...
public:
	...
	*/
	DinnerPartyTicket(Party *the_party, std::list<std::string>::iterator &me) : the_party(the_party), me(me) {}
